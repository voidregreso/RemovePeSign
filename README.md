...
This is a utility for removing the digital signatures from PE files, including exe, dll, sys, etc. Currently only support x86 Win32 platform. Soon I will add support for handling of other architectures (x64, arm, arm64).
